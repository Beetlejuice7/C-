...
/*void editstd()
{
    ...
    {
        cout << "Enter id of the student to modify : ";
        cin >> id;
        ...
        while (!file.eof())
        {
            if (id != std1.id)
            {
                file1 << " " << std1.id << " " << std1.name<< " " << std1.age << " " << std1.faculty << "\n";
            }
            else
            {
                ...
                cout << "Faculty : " << std1.faculty << endl << endl;
        ...
        file.close();
        file1.close();
        //remove orginal file and rename temporary file
        remove("std.txt");
        rename("temp.txt", "std.txt");

        if (!found)
        {
            cout << "No student found with ID : " << std1.id << endl;
        }
        else
        {
            cout << "Student information modified sucessfulluy." << endl;
        }
        cout << "Press enter to go back to menu..." << endl;
        cin.ignore();
        cin.get();
...
/*void editstd()
{
    ...
    file1.open("temp.txt", ios :: out);
        ...
        while (file1 >> std1.id >> std1.name >> std1.age >> std1.faculty)
    {
        if (id == std1.id)
        {
            found = true;
            ...
            cout << "Age : " << std1.age << endl;
            cout << "Faculty : " << std1.faculty << endl << endl;
            //ask user to modify information
            cout << "Enter name : ";
            cin >> std1.name;
            cout << "Enter age : ";
            cin >> std1.age;
